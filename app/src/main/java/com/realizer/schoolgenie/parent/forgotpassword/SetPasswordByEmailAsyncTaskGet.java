...
public class SetPasswordByEmailAsyncTaskGet extends AsyncTask<Void, Void,StringBuilder>
{
    ...
    public SetPasswordByEmailAsyncTaskGet(String uName, String email, Context myContext, OnTaskCompleted cb)
    {
        this.uName = uName;
        this.email = email;
    ...
    protected StringBuilder doInBackground(Void... params) {
        ...
        String my= Config.URL+"sendteacherforgotpassword/"+ uName + "/" +email;
        Log.d("URL", my);
    ...
    protected void onPostExecute(StringBuilder stringBuilder) {
       ...
       // dialog.dismiss();
        ...
        obj1.setType("SendEmail");
        obj1.setTime(jsonData);
        stringBuilder.append("@@@SendEmail");
