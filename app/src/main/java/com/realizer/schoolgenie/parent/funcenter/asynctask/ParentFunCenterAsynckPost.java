 ...
 */
public class ParentFunCenterAsynckPost extends AsyncTask<Void, Void,StringBuilder>
{
    ...
    public ParentFunCenterAsynckPost(ParentFunCenterModel o,Context myContext, OnTaskCompleted cb)
    {
    ...
    protected StringBuilder doInBackground(Void... params)
    {
        ...
        String url = Config.URL + "fetchDateSchoolEvents";
    ...
    protected void onPostExecute(StringBuilder stringBuilder) {
        ...
        stringBuilder.append("@@@FuncenterEvents");
